import OrdersHistory from "@/components/page-componennts/user/tabs/OrdersHistory";
import OrderHistory from "@/components/ui-components/orders/OrderHistory";
  ...
  return (
    <div className="w-full  ">
      ...
      <div className="mt-3 w-full ">
        ...
        >
          <div className="mx-auto bgs-gray-50 max-w-2xl  lg:max-w-7xl ">
